...
for i in range(97,98,1):
    ...
    plt.axis('off')
    plt.savefig('Better_exp_PRO_Yen.png', dpi=300)
    ...
    plt.imshow(array, cmap='gray')
    plt.axis('off')
    plt.savefig('Better_exp_PRO_Otsu.png', dpi=300)
    ...
    plt.imshow(array, cmap='gray')
    plt.axis('off')
    plt.savefig('Better_exp_PRO_Li.png', dpi=300)
    ...
    plt.imshow(array, cmap='gray')
    plt.axis('off')
    plt.savefig('Better_exp_PRO_Isodata.png', dpi=300)
    ...
    plt.imshow(array, cmap='gray')
    plt.axis('off')
    plt.savefig('Better_exp_PRO_Min.png', dpi=300)
    ...
    plt.imshow(array, cmap='gray')
    plt.axis('off')
    plt.savefig('Better_exp_PRO_Mean.png', dpi=300)
    ...
    plt.imshow(array, cmap='gray')
    plt.axis('off')
    plt.savefig('Better_exp_PRO_Triangle.png', dpi=300)
    # plt.hist(raw_arr_2D)
    # plt.show()
    ...
    plt.axvline(thresh_yen, linestyle='solid', color = 'k', label='Yen', linewidth=1)
    plt.axvline(thresh_otsu, linestyle='solid', color = 'b', label='Otsu', linewidth=1)
    plt.axvline(thresh_li, linestyle='solid', color = 'r', label='Li', linewidth=1)
    plt.axvline(thresh_mean, linestyle='solid', color = 'g', label='Mean', linewidth=1)
    plt.axvline(thresh_triangle, linestyle='dashed', color = 'c', label='Triangle', linewidth=1)
    ...
    plt.savefig("Better_exp_PRO_hist_2.png", dpi=300)

    diff_1 = np.subtract(array_yen*1,array_otsu*1)
    diff_2 = np.subtract(array_yen*1,array_li*1)
    # diff_3 = array_yen-array_mean
    diff_3 = np.subtract(array_li*1,array_otsu*1)
    # diff_5 = array_otsu - array_mean
    # diff_6 = array_li - array_mean
    diff_4_inter = np.add(array_li*1,array_otsu*1)
    diff_4 = np.add(diff_4_inter,array_yen*1)
    ...
    plt.axis('off')
    plt.subplot(2, 2, 3)
    plt.imshow(diff_3, cmap='gray')
    plt.title('Li - Otsu')
    plt.axis('off')
    plt.subplot(2, 2, 4)
    plt.imshow(diff_4, cmap='inferno')
    # plt.title('Otsu - Li')
    plt.axis('off')
    # plt.subplot(2, 3, 5)
    # plt.imshow(diff_5, cmap='gray')
    # plt.title('Otsu - Mean')
    # plt.axis('off')
    # plt.subplot(2, 3, 6)
    # plt.imshow(diff_6, cmap='gray')
    # plt.title('Li - Mean')
    # plt.axis('off')

    plt.savefig('Better_exp_PRO_comparison_plot.png',bbox_inches='tight')

    diff_mean_1 = np.subtract(array_mean*1,array_otsu*1)
    plt.clf()
    plt.imshow(diff_mean_1, cmap='gray')
    plt.title('Mean - Otsu')
    plt.axis('off')
    plt.savefig('Better_exp_PRO_mean_comparison_plot.png',bbox_inches='tight')
