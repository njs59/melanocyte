...
# text = data.page()
image_show(raw_arr_2D_1)
image_show(raw_arr_2D_2)
image_show(raw_arr_2D_3)
image_show(raw_arr_2D_1-raw_arr_2D_2)
image_show(raw_arr_2D_1-raw_arr_2D_3)
image_show(raw_arr_2D_2-raw_arr_2D_3)

image_show_save(raw_arr_2D_2)
...
thresh = text_threshold(raw_arr_2D_2)
array = raw_arr_2D_2 > thresh
image_show(raw_arr_2D_2 > thresh)
...
thresh_yen = text_threshold_yen(raw_arr_2D_2)
array_yen = raw_arr_2D_2 > thresh_yen

thresh_otsu = text_threshold_otsu(raw_arr_2D_2)
array_otsu = raw_arr_2D_2 > thresh_otsu

thresh_li = text_threshold_li(raw_arr_2D_2)
array_li = raw_arr_2D_2 > thresh_li

thresh_isodata = text_threshold_isodata(raw_arr_2D_2)
array_isodata = raw_arr_2D_2 > thresh_isodata

thresh_min = text_threshold_minimum(raw_arr_2D_2)
array_min = raw_arr_2D_2 > thresh_min

thresh_mean = text_threshold_mean(raw_arr_2D_2)
array_mean = raw_arr_2D_2 > thresh_mean

thresh_triangle = text_threshold_triangle(raw_arr_2D_2)
array_triangle = raw_arr_2D_2 > thresh_triangle
